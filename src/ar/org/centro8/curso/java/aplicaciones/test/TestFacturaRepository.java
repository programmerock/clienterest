...
public class TestFacturaRepository {
    public static void main(String[] args) {
        ...
        System.out.println("Cargo 3 facturas con el método 'save'");
        Factura factura=new Factura(Letra.A, 143, "12-01-2017", 214.80, 1);
        fr.save(factura);
        Factura factura2 = new Factura(Letra.B, 142, "22-06-2018", 255.40, 2);
        fr.save(factura2);
        Factura factura3 = new Factura(Letra.C, 142, "05-12-2018", 122, 2);
        fr.save(factura3);
